import {  LoaderCircleIcon, PenSquareIcon, Printer, Trash2, X } from 'lucide-react'
...
const Allowances = () => {
    ...
    const {isLoading, data} = useGetAllAllowancesQuery()
    const [deleteDepartmentType,] = useDeleteAllowanceMutation();
  ...
  printWindow.document.write(`
    <html>
      ...
      <body>
        <h1 class="text-2xl font-bold text-center my-4">Allowance Report</h1>
