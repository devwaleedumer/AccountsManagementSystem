...
import {  useEditBasePayMutation, useGetBasePayByIdQuery } from "../../redux/services/basicPaysService";
...
const EditBasicPay = () => {
 const [showAlert, setShowAlert] = useState(true);
  ...
  const {id} = useParams()
  const {isLoading: basicPayLoading,data: basicPayData} = useGetBasePayByIdQuery(id)
  const [EditBasePay, { isLoading, isError, isSuccess }] =
      ...
      <div className="bg-image">
        <div className="mb-5 bg-primary-2 shadow-t-lg rounded-t-lg py-3">
          <div className=" text-primary-foreground  ml-2 flex items-center">
            ...
            <span> Edit Basic pay Scale</span>
          </div>
        </div>
        {
          showAlert && isSuccess &&  (
            <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 relative" role="alert">
              ...
              <p>Basic pay updated successfully</p>
