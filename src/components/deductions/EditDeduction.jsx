...
import { useEditDeductionMutation, useGetDeductionByIdQuery } from "../../redux/services/deductionService";
...
const EditDeduction = () => {
 ...
 const [showAlert, setShowAlert] = useState(true);
  ...
  const [CreateAllowance, { isLoading, isError, isSuccess }] =
    ...
    const { isLoading: allowanceIsLoading, data: allowanceData  } = useGetDeductionByIdQuery(id);
  const {
    register,
    handleSubmit,
    formState: { errors },
