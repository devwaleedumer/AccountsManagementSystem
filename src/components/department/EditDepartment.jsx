import { Loader, LoaderCircleIcon, PenBoxIcon, PlusIcon, XIcon } from "lucide-react";
...
import { useEditDepartmentMutation, useGetDepartmentByIdQuery } from "../../redux/services/departmentService";
...
const EditDepartment = () => {
 const [showAlert, setShowAlert] = useState(true);
  const {id} = useParams();
  const {isLoading: departmentIsLoading, data : departmentData} = useGetDepartmentByIdQuery(id);
  ...
  return ( 
    !departmentTypeLoading && !departmentIsLoading?
