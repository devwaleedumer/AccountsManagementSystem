...
import { useDeleteDesignationMutation, useGetAllDesignationQuery } from '../../redux/services/designationService';

const Designations = () => {
        const [filteredData, setFilteredData] = useState(null); // To store filtered data
    const {isLoading, data} = useGetAllDesignationQuery()
    const [deleteDepartmentType,] = useDeleteDesignationMutation();
