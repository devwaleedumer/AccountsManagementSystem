...
import { useEditEmployeeTypeMutation, useGetEmployeeTypeByIdQuery } from "../../redux/services/employeeTypeService";
...
const EditEmployeeType = () => {
 ...
 const [showAlert, setShowAlert] = useState(true);
  ...
  const [editDepartment, { isLoading, isError, isSuccess }] =
    ...
    const {isLoading:departmentLoading,data} = useGetEmployeeTypeByIdQuery(id); // Fetch the department type by id    
    const {
    register,
    handleSubmit,
    formState: { errors },
        ...
        </div>
        {
          showAlert && isSuccess &&  (
            <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 relative" role="alert">
              ...
              <p>EmployeeType Edited successfully</p>
