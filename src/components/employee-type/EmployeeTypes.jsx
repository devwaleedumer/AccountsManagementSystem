...
import { useDeleteEmployeeTypeMutation, useGetAllEmployeeTypeQuery } from '../../redux/services/employeeTypeService';

const EmployeeTypes = () => {
        const [filteredData, setFilteredData] = useState(null); // To store filtered data
    const {isLoading, data} = useGetAllEmployeeTypeQuery()
    const [deleteDepartmentType,] = useDeleteEmployeeTypeMutation();
