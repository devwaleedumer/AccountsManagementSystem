...
import { useCreateEmployeeDeductionMutation, useGetAllEmployeeDeductionQuery } from "../../../redux/services/deductionService";
// Validation schema using Yup
const schema = yup.object().shape({
  allowanceId: yup.number().required("Deduction is required")
      .typeError("Please select a valid deduction"), // Ensures a valid number is selected
});
const CreateEmployeeDeduction = () => {
 const [showAlert, setShowAlert] = useState(true);
  ...
  const {isLoading:departmentTypeLoading, data} = useGetAllEmployeeDeductionQuery(id);
        ...
        </div>
        {
          showAlert && isSuccess &&  (
            <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 relative" role="alert">
              ...
              <p>Employee Deduction  created successfully</p>
...
export default CreateEmployeeDeduction;
